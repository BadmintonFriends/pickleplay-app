                ...
                <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100">
                  ...
                  <div className="relative h-44 overflow-hidden cursor-pointer" onClick={() => navigate(`/tournament/${t.id}`)}>
                    ...
                    <div className="absolute bottom-3 left-3 right-3">
                      <h2 className="text-lg font-black text-white leading-tight">{t.name}</h2>
                    </div>
                  </div>
                  ...
                  <div className="p-4">
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-bold text-[#1a1a2e] mt-0.5">{t.venue}</p>
                      ...
                      {t.status === "open" && (
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm font-bold text-green-600 mt-0.5">접수 중</p>
                            <p className="text-xs text-gray-400 mt-0.5">지금 바로 참가 신청하세요!</p>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mt-4 flex gap-2">
                      <button
                        ...
                        className="flex-1 bg-gray-100 text-[#1a1a2e] text-xs font-bold py-3 rounded-xl hover:bg-gray-200 transition-colors flex items-center justify-center gap-1.5 active:scale-[0.98]"
                      >
