    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="px-4 pb-10">
        <div className="bg-card rounded-2xl p-5  border border-line-strong prose prose-sm max-w-none text-secondary-foreground">
          <h2 className="text-base font-bold text-foreground mt-0">제1조 (목적)</h2>
          <p>
          ...
          <h2 className="text-base font-bold text-foreground">제4조 (회원가입)</h2>
          <ol className="list-decimal pl-5 space-y-1">
          ...
          <h2 className="text-base font-bold text-foreground">제5조 (서비스의 제공 및 변경)</h2>
          <ol className="list-decimal pl-5 space-y-1">
          ...
          <h2 className="text-base font-bold text-foreground">제6조 (대회 참가 신청)</h2>
          <ol className="list-decimal pl-5 space-y-1">
          ...
          <h2 className="text-base font-bold text-foreground">제7조 (회원의 의무)</h2>
          <ol className="list-decimal pl-5 space-y-1">
