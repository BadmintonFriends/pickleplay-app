...
## Phase 30: KPR(Korea Pickleball Ranking) 대시보드
- [x] KPR 시스템 설계 (EloRating 기반 → KPL 7.00 스케일로 변경)
- [x] DB 스키마 추가 (kpr_ratings, match_results 테이블)
- [x] 서버 API 구현 (myDashboard, leaderboard, stats)
- [x] HomePage 배너를 KPL 대시보드로 교체
- [x] 비로그인 시 KPR 소개 + 로그인 유도 UI
- [x] KPL 7.00 스케일 점수 체계 적용 (DB rating 필드 decimal(4,2) 변환)
- [x] 첨부 UI 디자인 기반 KPR 카드 재구현 (KPL 위젯 스타일)
- [x] 비로그인 시 KPL 소개 + 로그인 유도 UI
- [x] vitest 테스트 추가 (60건 전체 PASS)
